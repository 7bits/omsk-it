...
-- 12 IT-субботник
insert into `conference`(id, company_id, ordinal_number, date, registration) values(12, 1, 12, 1406937600, true);
insert into user(id, login, password, first_name, second_name, email, job_position, confirmation_token, enabled, photo, company_id, self_description) values (32, 'alexey.tsitrkop@7bits.it', '$2a$10$r765yhWnFyYpxncqjhXWgOU/OVy0D.dc4D3.5Iyf8fonu6yCyBkvu', 'Дмитрий', 'Голушко', 'alexey.tsitrkop@7bits.it', 'Java Developer', 1111111, true, 'dgolushko.png', 3, null);
INSERT INTO user_roles (user_id, role_id) VALUES (32, 3);
...
insert into user(id, login, password, first_name, second_name, email, job_position, confirmation_token, enabled, photo, company_id, self_description) values (28, 'rodionov@gmail.com', '111111', 'Алексей', 'Родионов', 'godionov@gmail.com', null, 1111111, true, 'rodionov.png', 6, null);
INSERT INTO user_roles (user_id, role_id) VALUES (27, 3);
INSERT INTO user_roles (user_id, role_id) VALUES (28, 3);

insert into `report`(id, conference_id, user_id, title, description, presentation, video, other_conferences, key_technologies, reporter_wishes) values(31, 11, 27, "Обзор фреймворка Thucydides", "Обзор основанного на Selenuim фреймворка Thucydides. Он предназначен для написания тестов, имитирующих действия пользователя в браузере, и построения отчетов по их прохождению. Сейчас Thucydides - активно развивающийся open source проект, поддерживающий основные браузеры, параллельный запуск тестов, параметризацию тестов.", 'http://www.slideshare.net/slideshow/embed_code/27057411', '//player.vimeo.com/video/76500586', null, null, null);
insert into `report`(id, conference_id, user_id, title, description, presentation, video, other_conferences, key_technologies, reporter_wishes) values(32, 11, 28, "Как мы делали свой Travis CI: Vagrant + KVM", "Автор расскажет, как его команда построила гибкую VM-based систему непрерывной интеграции с помощью Vagrant и Linux KVM.", '//www.slideshare.net/slideshow/embed_code/27057432', '//player.vimeo.com/video/76501005', null, null, null);
...
insert into `report`(id, conference_id, user_id, title, description, presentation, video, other_conferences, key_technologies, reporter_wishes) values(27, 9, 25, "Start-up accelerator изнутри", "Впечатления и опыт прохождения через start-up accelerator LightningLab в качестве virtual CTO . LighningLab был построен по типу TechCrunch.", '//www.slideshare.net/slideshow/embed_code/24937466','//player.vimeo.com/video/71798655', null, null, null);
...
insert into `report`(id, conference_id, user_id, title, description, presentation, video, other_conferences, key_technologies, reporter_wishes) values(22, 8, 22, "BigData inside. Архитектурные изыскания в HBase", "Вы узнаете много всего про Hbase, примеры применения, отличные BigData кейсы и прочее. также будет затронут Hadoop.", '//www.slideshare.net/slideshow/embed_code/24616155', '//player.vimeo.com/video/71227795', null, null, null);
insert into `report`(id, conference_id, user_id, title, description, presentation, video, other_conferences, key_technologies, reporter_wishes) values(23, 8, 10, "житейским опытом приготовления Cassandra", "Он после долги уговоров решил приоткрыть завесу над вопросом - \"а зачем она вообще нужна?\")))", '//www.slideshare.net/slideshow/embed_code/24616177', '//player.vimeo.com/video/71227796', null, null, null);
insert into `report`(id, conference_id, user_id, title, description, presentation, video, other_conferences, key_technologies, reporter_wishes) values(24, 8, 2, "Javascript - библиотека под Android и iOS", "Он пожалуется вам на судьбу, которая столкнула его с задачей портирования одной Javascript - библиотеки под Android и iOS", '//www.slideshare.net/slideshow/embed_code/24616198', '//player.vimeo.com/video/71227794', null, null, null);

-- 7 IT-субботник
insert into `conference`(id, company_id, ordinal_number, date, registration) values(7, 7, 7, 1370080800, false);

insert into user(id, login, password, first_name, second_name, email, job_position, confirmation_token, enabled, photo, company_id, self_description) values (20,'korovianski@gmail.com','111111','Алексей', 'Коровянский','korovianski@gmail.com',null,null,true,'Korovjanskij.png',10,null);
insert into user(id, login, password, first_name, second_name, email, job_position, confirmation_token, enabled, photo, company_id, self_description) values (21,'lifar@gmail.com','111111','Дмитрий','Лыфарь','lifar@gmail.com','Соучредитель',null,true,'Lifar_.png',9,null);
INSERT INTO user_roles (user_id, role_id) VALUES (20, 3);
INSERT INTO user_roles (user_id, role_id) VALUES (21, 3);

insert into `report`(id, conference_id, user_id, title, description, presentation, video, other_conferences, key_technologies, reporter_wishes) values(20, 7, 20, "Google I/O туда и обратно.", "Рассказ лидеров GDG Omsk о поездке на Google I/O в Сан-Франциско. Вы узнаете, насколько сложно попасть в Силиконовую долину, что такое GDG -братство во всемирном масштабе, и как стучат сердца, когда Ларри Пейдж дарит благую весть о грядущем.", '//www.slideshare.net/slideshow/embed_code/22520104', '//player.vimeo.com/video/67648961', null, null, null);
insert into `report`(id, conference_id, user_id, title, description, presentation, video, other_conferences, key_technologies, reporter_wishes) values(21, 7, 21, "\"Другой\" outsource и production development", "ассказ об аутсорсе, которым занимается компания (C++ проекты), а также о попытках перейти на продуктовую разработку и что из этого получилось", '//www.slideshare.net/slideshow/embed_code/22520162', '//player.vimeo.com/video/68193238', null, null, null);

-- 6 IT-субботник
insert into `conference`(id, company_id, ordinal_number, date, registration) values(6, 1, 6, 1367661030, false);

insert into user(id, login, password, first_name, second_name, email, job_position, confirmation_token, enabled, photo, company_id, self_description) values (17,'dmitrieva@gmail.com','111111','Ксения', 'Дмитриева','korovianski@gmail.com','Консультант по безопасности',null,true,'Dmitr_.png',11,null);
insert into user(id, login, password, first_name, second_name, email, job_position, confirmation_token, enabled, photo, company_id, self_description) values (18,'korsakov@gmail.com','111111','Сергей', 'Корсаков','korsakov@gmail.com','PM',null,true,'Korsakov.png',12,null);
...
insert into user(id, login, password, first_name, second_name, email, job_position, confirmation_token, enabled, photo, company_id, self_description) values (16,'pavlova@gmail.com','111111','Ольга', 'Павлова','pavlova@gmail.com','Совладелец',null,true,'pavlova.jpg',18,null);
INSERT INTO user_roles (user_id, role_id) VALUES (14, 3);
INSERT INTO user_roles (user_id, role_id) VALUES (16, 3);

insert into `report`(id, conference_id, user_id, title, description, presentation, video, other_conferences, key_technologies, reporter_wishes) values(15, 5, 14, "Архитектура в Agile проекте", "Разработка программного обеспечения, базирующаяся на архитектуре, и разработка программного обеспечения по методологии Agile концептуально несовместимые процессы. Однако, практика показывает, что создать качественный продукт без проработки архитектуры зачастую невозможно. Хотелось бы поделиться опытом внедрения архитектурных практик в Agile процесс, зафиксировав основные цели, активности и техники, используемые при этом.", 'http://www.slideshare.net/slideshow/embed_code/18340165', '//player.vimeo.com/video/63959954', null, null, null);
insert into `report`(id, conference_id, user_id, title, description, presentation, video, other_conferences, key_technologies, reporter_wishes) values(16, 5, 31, "HWdTech.DS - message-ortiented middleware", "В данном докладе будет рассказано об архитектуре и опыте внедрения собственной open-source распределенной системы серверов приложений. Будут рассмотрены программные решения, повышающие надежность системы, а также ключевые компоненты. В настоящий момент сервер внедряется в нескольких проектах, в том числе одном стартапе и одном высоконагруженном (1 млн. просмотров страниц в сутки) веб-сайте.", '/www.slideshare.net/slideshow/embed_code/18340202','//player.vimeo.com/video/63960098', null, null, null);
insert into `report`(id, conference_id, user_id, title, description, presentation, video, other_conferences, key_technologies, reporter_wishes) values(17, 5, 16, "Тексты в интерфейсах", "Почему 37 важнее, чем 42? Как выглядит хорошо структурированная шизофрения? Почему импотенты любят уникальные предложения? Ну и другие речевые чудеса в нашем с вами интернет-пространстве. Разговор, как всегда, для менеджеров и сочувствующих", '//www.slideshare.net/slideshow/embed_code/18340238', '//player.vimeo.com/video/64141660', null, null, null);

-- 4 IT-субботник
insert into `conference`(id, company_id, ordinal_number, date, registration) values(4, 1, 4, 1365249234, false);

insert into user(id, login, password, first_name, second_name, email, job_position, confirmation_token, enabled, photo, company_id, self_description) values (12,'babienko@gmail.com','111111','Леонид', 'Бабиенко','babienko@gmail.com','Генеральный директор',null,true,'babienko.png',15,null);
insert into user(id, login, password, first_name, second_name, email, job_position, confirmation_token, enabled, photo, company_id, self_description) values (13,'pashkevich@gmail.com','111111','Дмитрий', 'Пашкевич','pashkevich@gmail.com','Директор',null,true,'dpashkevich.jpg',2,null);
...
insert into user(id, login, password, first_name, second_name, email, job_position, confirmation_token, enabled, photo, company_id, self_description) values(9,'nelubin@gmail.com','111111','Денис', 'Нелюбин','nelubin@gmail.com',null,null,true,'dnelubin.jpg',2,null);
insert into user(id, login, password, first_name, second_name, email, job_position, confirmation_token, enabled, photo, company_id, self_description) values(11,'nepomnashih@gmail.com','111111','Антон', 'Непомнящих','nepomnashih@gmail.com',null,null,true,'Nepomn_.png',17,null);
...
insert into `report`(id, conference_id, user_id, title, description, presentation, video, other_conferences, key_technologies, reporter_wishes) values(8, 3, 8, "Прокладка между софтом и железом", "Виртуализация рулит. Зачем нужна виртуализация и как она делает людей счастливыми. Гипервизор, VMWare, VirtualBox, Xen, прикладной аспект.", '//www.slideshare.net/slideshow/embed_code/16308522', '//player.vimeo.com/video/58810809', null, null, null);
insert into `report`(id, conference_id, user_id, title, description, presentation, video, other_conferences, key_technologies, reporter_wishes) values(9, 3, 9, "Почему NoSQL", "Ответы на вопросы: Что такое NoSQL? Почему он возник? Зачем и когда он нужен?", '//www.slideshare.net/slideshow/embed_code/16308537', '//player.vimeo.com/video/58810811', null, null, null);
insert into `report`(id, conference_id, user_id, title, description, presentation, video, other_conferences, key_technologies, reporter_wishes) values(10, 3, 10, "Полнотекстовый поиск с Elasticsearch", "Рассмотрим базовые основы полнотекстового поиска. Основы непосредственно Elasticsearch. Небольшой рассказ о том что мы планируем делать с Elasticsearch у себя в компании.", '//www.slideshare.net/slideshow/embed_code/16308555', '//player.vimeo.com/video/59063666', null, null, null);
insert into `report`(id, conference_id, user_id, title, description, presentation, video, other_conferences, key_technologies, reporter_wishes) values(11, 3, 11, "Распределение человеческих ресурсов по проектам без простоев и скамейки запасных", "Доклад для тех, кто руководит менеджерами проектов и распределяет ресурсы по проектам: - как решить проблему распределения ресурсов между проектами. - сколько надо народу в фирме. - зачем нужно специализироваться на одной технологии, а не хвататься за все подряд.", '//www.slideshare.net/slideshow/embed_code/16308576', '<//player.vimeo.com/video/59063669', null, null, null);
...
insert into `report`(id, conference_id, user_id, title, description, presentation, video, other_conferences, key_technologies, reporter_wishes) values(4, 2, 4, "Тестировании мобильных приложений", "Здравствуйте! Меня зовут Миттова Юлия. Для всех, кто выжил после празднования Нового Года и конца света, буду рада рассказать о тестировании мобильных приложений.", 'http://www.slideshare.net/slideshow/embed_code/15873290', '//player.vimeo.com/video/56818661', null, null, null);
insert into `report`(id, conference_id, user_id, title, description, presentation, video, other_conferences, key_technologies, reporter_wishes) values(5, 2, 5, "Типографика для не дизайнеров", "1. Что такое типографика? 2. Почему программисту надо быть немного дизайнером? 3. Макро- микро- типографика 4. Использование модульных сеток 5. Простые правила микротипографики", 'http://www.slideshare.net/slideshow/embed_code/15873345', '//player.vimeo.com/video/57376847', null, null, null);
insert into `report`(id, conference_id, user_id, title, description, presentation, video, other_conferences, key_technologies, reporter_wishes) values(6, 2, 18, "Онлайн обучение.", "- для чего обучаться - где обучаться - как много занимает он-лайн обучение", 'http://www.slideshare.net/slideshow/embed_code/15873314', '//player.vimeo.com/video/56818663', null, null, null);
insert into `report`(id, conference_id, user_id, title, description, presentation, video, other_conferences, key_technologies, reporter_wishes) values(7, 2, 7, "Web-scale. Взорвётся всё.", "Я хочу рассказать о некотором числе неприятных и не всегда очевидных особенностей инструментов, которые мы эксплуатируем ежедневно: MySQL, MongoDB, Python, Linux & FreeBSD.", 'http://www.slideshare.net/slideshow/embed_code/15873254', '//player.vimeo.com/video/56818662', null, null, null);
