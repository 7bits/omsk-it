...
insert into user(id, login, password, first_name, second_name, email, job_position, confirmation_token, enabled, photo, company_id, self_description) values (31, 'tumen@gmail.com', '$2a$10$SPpuqt9.umB.uYYiMUpryOLXxorIWFVs.2rRHRA99wwpgMPEv9q.q', 'Евгений', 'Тюменцев', 'tumen@gmail.com', 'Управляющий партнер', 1111111, true, 'Tumentsev.png', 5, null);
