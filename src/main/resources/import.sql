...
insert into `report`(id, conference_id, user_id, title, description, presentation, video, other_conferences, key_technologies, reporter_wishes) values(23, 8, 10, "житейским опытом приготовления Cassandra", "Он после долги уговоров решил приоткрыть завесу над вопросом - \"а зачем она вообще нужна?\")))", null, null, null, null, null);
...
insert into `report`(id, conference_id, user_id, title, description, presentation, video, other_conferences, key_technologies, reporter_wishes) values(9, 3, 9, "Почему NoSQL", "Ответы на вопросы: Что такое NoSQL? Почему он возник? Зачем и когда он нужен?", null, null, null, null, null);
...
insert into user(id, login, password, first_name, second_name, email, job_position, confirmation_token, enabled, photo, company_id, self_description) values(4,'mittova@gmail.com','111111','Юлия', 'Миттова','mittova@gmail.com',null,null,true,null,null,null);
...
insert into user(id, login, password, first_name, second_name, email, job_position, confirmation_token, enabled, photo, company_id, self_description) values(6,'korsakov@gmail.com','111111','Сергей', 'Корсаков','korsakov@gmail.com',null,null,true,null,null,null);
...
insert into `report`(id, conference_id, user_id, title, description, presentation, video, other_conferences, key_technologies, reporter_wishes) values(6, 2, 6, "Онлайн обучение.", "- для чего обучаться - где обучаться - как много занимает он-лайн обучение", null, null, null, null, null);
