...
INSERT INTO user (login, password, enabled) VALUES ('moder', '111111', true), ('adm', '222222', true);
...
insert into user(id, login, password, first_name, second_name, email, job_position, confirmation_token, enabled) values (6, 'glush@gmail.com', '111111', 'Дмитрий', 'Глушко', 'glush@gmail.com', 'Java Developer', 1111111, true);
insert into user(id, login, password, first_name, second_name, email, job_position, confirmation_token, enabled) values (7, 'samol@gmail.com', '111111', 'Александр', 'Самолов', 'samol@gmail.com', 'Технический директор', 1111111, true);
insert into user(id, login, password, first_name, second_name, email, job_position, confirmation_token, enabled) values (8, 'tumen@gmail.com', '111111', 'Евгений', 'Тюменцев', 'tumen@gmail.com', 'Управляющий партнер Тик-Так Коуч ', 1111111, true);
INSERT INTO user_roles (user_id, role_id) VALUES (6, 2);
INSERT INTO user_roles (user_id, role_id) VALUES (7, 2);
INSERT INTO user_roles (user_id, role_id) VALUES (8, 2);

insert into `report`(id, conference_id, user_id, title, description, presentation, video, other_conferences, key_technologies, reporter_wishes) values(34, 12, 6, "Впечатления от Grails после одного проекта", "Впечатления по большей части положительные. Давно искал web-фреймворк на Java, который можно было бы использовать без кучи xml конфигов, без необходимости прочесть ВСЮ документацию. Я пробовал ASP.NET MVC 4. Круто. Можно писать просто, но чтобы сделать что-то более-менее сложное, приходится извращаться. Опять же Entity Framework, который в неумелых руках превращается в монстра. Короче, как говорится, не зашло. А Grails можно взять и работать. Это отличный инструмент, который позволяет делать практически всё что нужно. Более того, радует что \"под капотом\" у него Spring и Hibernate, которые однако скрыты более простыми и удобными собственными инструментами Grails. Одним словом слоган на сайте Grails \"The search is over\" оказался для меня верным.", null, null, null, null, null);
insert into `report`(id, conference_id, user_id, title, description, presentation, video, other_conferences, key_technologies, reporter_wishes) values(35, 12, 7, "Фреймворки - сладкое зло, или почему я не люблю использовать фреймворки", "Я не хочу устраивать \"холиварный\" доклад, но хочу поделиться своим мнением почему я не люблю фреймворки и с нежностью отношусь к \"велосипедам\". Хочу рассказать про те факапы, которые я поимел, используя веб фреймворки в java и аргументированно рассказать о профитах, если использовать что-то свое.", null, null, null, null, null);
insert into `report`(id, conference_id, user_id, title, description, presentation, video, other_conferences, key_technologies, reporter_wishes) values(36, 12, 8, "HWdTech.DS - message-oriented middleware, продолжение", "Евгений ответит на вопрос, заданный на 1-й части доклада: \"Почему не Erlang?\" Средства управления платформой: ServiceManager Библиотека сервисов Управление конфигурацией Взаимозаменяемость компонентов", null, null, null, null, null);
