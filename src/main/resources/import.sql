...
insert into `reporter`(id, company_id, first_name, second_name, email, photo, self_description, job_position, speech_experience) values(10, 3, "Дмитрий", "Голушко", null, "/resources/images/photos/dgolushko.jpg", null, "Java Developer", null);
insert into `reporter`(id, company_id, first_name, second_name, email, photo, self_description, job_position, speech_experience) values(30, 4, "Александр", "Самолов", null, "/resources/images/photos/asamolov.jpg", null, "Технический директор", null);
insert into `reporter`(id, company_id, first_name, second_name, email, photo, self_description, job_position, speech_experience) values(31, 5, "Евгений", "Тюменцев", null, "/resources/images/photos/nophoto.png", null, "Управляющий партнер компании “Тик-Так Коуч”", null);
...
insert into `reporter`(id, company_id, first_name, second_name, email, photo, self_description, job_position, speech_experience) values(27, 2, " Екатерина", "Боброва", null, "/resources/images/photos/nophoto.png", null, null, null);
insert into `reporter`(id, company_id, first_name, second_name, email, photo, self_description, job_position, speech_experience) values(28, 6, "Алексей", "Родионов", null, "/resources/images/photos/nophoto.png", null, null, null);
...
insert into `reporter`(id, company_id, first_name, second_name, email, photo, self_description, job_position, speech_experience) values(2, 2, "Алексей", "Зиновьев", null, "/resources/images/photos/nophoto.png", null, null, null);
insert into `reporter`(id, company_id, first_name, second_name, email, photo, self_description, job_position, speech_experience) values(26, 7, "Сергей", "Назаренко", null, "/resources/images/photos/nophoto.png", null, null, null);
insert into `reporter`(id, company_id, first_name, second_name, email, photo, self_description, job_position, speech_experience) values(1, 1, "Анна", "Тарасенко", null, "/resources/images/photos/nophoto.png", null, "директор", null);
...
insert into `reporter`(id, company_id, first_name, second_name, email, photo, self_description, job_position, speech_experience) values(23, 8, "Михаил", "Подгурский", null, "/resources/images/photos/nophoto.png", null, "начальник отдела банковских систем УБСДИТ", null);
insert into `reporter`(id, company_id, first_name, second_name, email, photo, self_description, job_position, speech_experience) values(24, 2, "Александр", "Шиповалов", null, "/resources/images/photos/nophoto.png", null, "инженер по тестированию", null);
insert into `reporter`(id, company_id, first_name, second_name, email, photo, self_description, job_position, speech_experience) values(25, 9, "Роман", "Кудияров", null, "/resources/images/photos/nophoto.png", null, "Соучредитель", null);
...
insert into `reporter`(id, company_id, first_name, second_name, email, photo, self_description, job_position, speech_experience) values(22, 2, "Анатолий", "Никулин", null, "/resources/images/photos/nophoto.png", null, null, null);
...
insert into `reporter`(id, company_id, first_name, second_name, email, photo, self_description, job_position, speech_experience) values(20, 10, "Алексей", "Коровянский", null, "/resources/images/photos/nophoto.png", null, null, null);
insert into `reporter`(id, company_id, first_name, second_name, email, photo, self_description, job_position, speech_experience) values(21, 9, "Дмитрий", "Лыфарь", null, "/resources/images/photos/nophoto.png", null, "соучредитель", null);
...
insert into `reporter`(id, company_id, first_name, second_name, email, photo, self_description, job_position, speech_experience) values(17, 11, "Ксения", "Дмитриева", null, "/resources/images/photos/nophoto.png", null, "консультант по безопасности", null);
insert into `reporter`(id, company_id, first_name, second_name, email, photo, self_description, job_position, speech_experience) values(18, 12, "Сергей", "Корсаков", null, "/resources/images/photos/nophoto.png", null, "PM", null);
insert into `reporter`(id, company_id, first_name, second_name, email, photo, self_description, job_position, speech_experience) values(19, 13, "Юлия", "Герасимович", null, "/resources/images/photos/nophoto.png", null, "Владелец", null);
...
insert into `reporter`(id, company_id, first_name, second_name, email, photo, self_description, job_position, speech_experience) values(14, 7, "Максим", "Юнусов", null, "/resources/images/photos/nophoto.png", null, "Group Manager", null);
insert into `reporter`(id, company_id, first_name, second_name, email, photo, self_description, job_position, speech_experience) values(15, 14, "Евгений", "Тюменцев", null, "/resources/images/photos/nophoto.png", null, "старший преподаватель", null);
insert into `reporter`(id, company_id, first_name, second_name, email, photo, self_description, job_position, speech_experience) values(16, 18, "Ольга", "Павлова", null, "/resources/images/photos/nophoto.png", null, "совладелец", null);
...
insert into `reporter`(id, company_id, first_name, second_name, email, photo, self_description, job_position, speech_experience) values(12, 15, "Леонид", "Бабиенко", null, "/resources/images/photos/nophoto.png", null, "генеральный директор", null);
insert into `reporter`(id, company_id, first_name, second_name, email, photo, self_description, job_position, speech_experience) values(13, 2, "Дмитрий", "Пашкевич", null, "/resources/images/photos/nophoto.png", null, "директор", null);
...
insert into `reporter`(id, company_id, first_name, second_name, email, photo, self_description, job_position, speech_experience) values(8, null, "Сергей", "Сусиков", null, "/resources/images/photos/nophoto.png", null, "self-employed", null);
insert into `reporter`(id, company_id, first_name, second_name, email, photo, self_description, job_position, speech_experience) values(9, 2, "Денис", "Нелюбин", null, "/resources/images/photos/nophoto.png", null, null, null);
insert into `reporter`(id, company_id, first_name, second_name, email, photo, self_description, job_position, speech_experience) values(11, 17, "Антон", "Непомнящих", null, "/resources/images/photos/nophoto.png", null, null, null);
...
insert into `reporter`(id, company_id, first_name, second_name, email, photo, self_description, job_position, speech_experience) values(4, null, "Юлия", "Миттова", null, "/resources/images/photos/nophoto.png", null, null, null);
insert into `reporter`(id, company_id, first_name, second_name, email, photo, self_description, job_position, speech_experience) values(5, 16, "Александр", "Омельницкий", null, "/resources/images/photos/nophoto.png", null, null, null);
insert into `reporter`(id, company_id, first_name, second_name, email, photo, self_description, job_position, speech_experience) values(6, null, "Сергей", "Корсаков", null, "/resources/images/photos/nophoto.png", null, null, null);
insert into `reporter`(id, company_id, first_name, second_name, email, photo, self_description, job_position, speech_experience) values(7, 12, "Леонид", "Евдокимов", null, "/resources/images/photos/nophoto.png", null, "Разработчик систем мониторинга", null);
...
insert into `reporter`(id, company_id, first_name, second_name, email, photo, self_description, job_position, speech_experience) values(3, 7, "Серик", "Бейсенов", null, "/resources/images/photos/nophoto.png", null, null, null);
