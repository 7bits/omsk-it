...
insert into `reporter`(id, company_id, first_name, second_name, email, photo, self_description, job_position, speech_experience) values(10, 3, "Дмитрий", "Голушко", null, "dgolushko.jpg", null, "Java Developer", null);
insert into `reporter`(id, company_id, first_name, second_name, email, photo, self_description, job_position, speech_experience) values(30, 4, "Александр", "Самолов", null, "asamolov.jpg", null, "Технический директор", null);
