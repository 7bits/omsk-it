        ...
        <div class="box">
            ...
            <form class="js-apply-user-registration-form form-content" action='<c:url value="/user/registration"/>' method="POST">
                ...
                <div class="field">
                    ...
                    <input class="js-first-name-input js-input small-input margin-top-8" type="text" name="firstName" value='<c:out value="${userVkontakteFirstName}"/>'/>
                ...
                <div class="field">
                    ...
                    <input class="js-second-name-input js-input small-input margin-top-8" type="text" name="secondName" value='<c:out value="${userVkontakteSecondName}"/>'/>
                    <span class="field-info">
                        <span class="js-field-info">На русском языке</span>
                    </span>
