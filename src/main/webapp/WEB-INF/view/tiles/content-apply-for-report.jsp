            ...
            <div class="form-content">
                <form class="js-apply-form" action='<c:url value="/apply-for-report"/>' method="POST">
                    ...
                    <div class="field">
                        ...
                        <span class="js-first-name-response js-field-info field-info">На русском языке</span>
                    </div>
                    ...
                    <div class="field">
                        ...
                        <span class="js-second-name-response js-field-info field-info">На русском языке</span>
                    </div>
                    ...
                    <div class="field">
                        ...
                        <span class="js-email-response js-field-info field-info">Информационное письмо придет примерно за сутки до начала мероприятия</span>
                    </div>
                    ...
                    <div class="field">
                        ...
                        <span class="js-job-response js-field-info field-info"></span>
                    </div>
                    ...
                    <div class="field">
                        ...
                        <span class="js-job-position-response js-field-info field-info"></span>
                    </div>

                    <div class="field">
                        <span class="top-label">Название доклада&nbsp;<span class="attention">*</span></span>
                        <span class="js-title-response js-field-info field-info">Если точного названия еще нет, то напишите предполагаемое</span>
                    ...
                    <div class="field">
                        ...
                        <span class="js-description-response js-field-info field-info">Расскажите, пожалуйста, тремя-четырьмя предложениями, о чем будет ваш доклад</span>
                    ...
                    <div class="field">
                        ...
                        <span class="js-key-technologies-response js-field-info field-info">Это очень важно. Пример: web, nosql, нагрузочное тестирование, менеджмент, стартап, mobile, ios, java, ...</span>
                    ...
                    <div class="field">
                        ...
                        <span class="js-other-conferences-response js-field-info field-info"></span>
                    ...
                    <div class="field">
                        ...
                        <span class="js-speech-experience-response js-field-info field-info">Нет ничего страшного в том, если у вас нет опыта. В этом случае мы поможем вам подготовить доклад.</span>
                    ...
                    <div class="field">
                        ...
                        <span class="js-reporter-wishes-response js-field-info field-info">Постарайтесь написать все, что поможет нам организовать ваш доклад наилучшим образом.</span>
