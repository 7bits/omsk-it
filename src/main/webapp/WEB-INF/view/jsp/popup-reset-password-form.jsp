...
<div class="js-reset-password-form-container popup-container">
    ...
    <div class = "popup-form-container">
        ...
        <div class = "box-content">
            ...
            <div class = "field">
                ...
                <input class = "js-reset-password-email-form-input input pos-input  " type="text" name="email" />
            </div>
            <div class = "reset-password-label"></div>
            <div class = "js-reset-password-response attention attention-reset-password"></div>
            ...
            <div class = "js-reset-password-notification"></div>
        </div>
